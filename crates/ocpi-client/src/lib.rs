...
// `TaxAmount` list for North-American GST/QST) and its `tariffs` list embedding
// the 2.3.0 `Tariff`. Every other field is wire-identical to 2.2.1. See
// `crate::OcpiClient::get_cdrs_2_3_0`.
