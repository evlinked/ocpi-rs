...
pub mod http {
    ...
    use crate::{
        ...
        Payments230Config, ServerError, Sessions2111Config, SessionsConfig, Tariffs2111Config,
        Tariffs230Config, TariffsConfig, Tokens2111Config, TokensConfig, VersionsConfig,
    };
